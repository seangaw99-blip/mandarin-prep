...
export const cheatsheets: CheatSheet[] = [
  ...
  },
  {
    ...
    icon: "👋",
    description: "Introducing yourself at meetings and social situations",
    color: "bg-indigo-500",
    phrases: [
      { chinese: "你好，我叫Sean", pinyin: "Nǐ hǎo, wǒ jiào Sean", english: "Hello, my name is Sean" },
      { chinese: "我是菲律宾人", pinyin: "Wǒ shì Fēilǜbīn rén", english: "I am Filipino" },
      { chinese: "我们是菲律宾的华侨", pinyin: "Wǒmen shì Fēilǜbīn de huáqiáo", english: "We are overseas Chinese from the Philippines" },
      { chinese: "我在包装制造公司工作", pinyin: "Wǒ zài bāozhuāng zhìzào gōngsī gōngzuò", english: "I work at a packaging manufacturing company" },
      { chinese: "很高兴认识你", pinyin: "Hěn gāoxìng rènshi nǐ", english: "Nice to meet you" },
      { chinese: "这是我的名片", pinyin: "Zhè shì wǒ de míngpiàn", english: "Here is my business card" },
      { chinese: "你做什么工作？", pinyin: "Nǐ zuò shénme gōngzuò?", english: "What do you do for work?" },
      { chinese: "你是哪国人？", pinyin: "Nǐ shì nǎ guó rén?", english: "Where are you from?" },
      { chinese: "你家有几口人？", pinyin: "Nǐ jiā yǒu jǐ kǒu rén?", english: "How many in your family?" },
      { chinese: "请多关照", pinyin: "Qǐng duō guānzhào", english: "Please look after me (polite)" },
    ],
  },
  {
    id: "cs-shopping",
    ...
    icon: "🛒",
    description: "Buying things, asking prices, and using measure words",
    color: "bg-teal-500",
    phrases: [
      { chinese: "这个多少钱？", pinyin: "Zhège duōshao qián?", english: "How much is this?" },
      { chinese: "西瓜多少钱一斤？", pinyin: "Xīguā duōshao qián yī jīn?", english: "How much per jin?" },
      { chinese: "苹果怎么卖？", pinyin: "Píngguǒ zěnme mài?", english: "How are apples sold?" },
      { chinese: "我要这个", pinyin: "Wǒ yào zhège", english: "I want this one" },
      { chinese: "还要别的吗？", pinyin: "Hái yào bié de ma?", english: "Anything else?" },
      { chinese: "一共多少钱？", pinyin: "Yīgòng duōshao qián?", english: "How much total?" },
      { chinese: "太贵了，便宜一点", pinyin: "Tài guì le, piányi yīdiǎn", english: "Too expensive, cheaper please" },
      { chinese: "给我两斤", pinyin: "Gěi wǒ liǎng jīn", english: "Give me two jin" },
      { chinese: "一瓶 / 一杯 / 一袋 / 一箱", pinyin: "yī píng / yī bēi / yī dài / yī xiāng", english: "One bottle / cup / bag / case" },
      { chinese: "给。", pinyin: "Gěi.", english: "Here you are (paying)" },
      { chinese: "不要了，谢谢", pinyin: "Bù yào le, xièxie", english: "No more, thanks" },
      { chinese: "有没有新鲜的？", pinyin: "Yǒu méiyǒu xīnxiān de?", english: "Do you have fresh ones?" },
    ],
  },
];

...
export const businessTerms: BusinessTerm[] = [
  ...
  // Lesson 3-8 - Additional Business Terms
  { id: "bt-36", chinese: "业务", pinyin: "yèwù", english: "Business", category: "business" },
  { id: "bt-37", chinese: "咨询", pinyin: "zīxún", english: "Consultation / Inquiry", category: "business" },
  { id: "bt-38", chinese: "款", pinyin: "kuǎn", english: "Type / Style", category: "business" },
  { id: "bt-39", chinese: "沟通", pinyin: "gōutōng", english: "Communication", category: "business" },
  { id: "bt-40", chinese: "确保", pinyin: "quèbǎo", english: "To ensure", category: "business" },
  { id: "bt-41", chinese: "产品", pinyin: "chǎnpǐn", english: "Product", category: "business" },
  { id: "bt-42", chinese: "符合", pinyin: "fúhé", english: "To meet / Conform to", category: "business" },
  { id: "bt-43", chinese: "要求", pinyin: "yāoqiú", english: "Requirements", category: "business" },
  { id: "bt-44", chinese: "批", pinyin: "pī", english: "Batch", category: "business" },
  { id: "bt-45", chinese: "颜色", pinyin: "yánsè", english: "Color", category: "business" },
  { id: "bt-46", chinese: "提前", pinyin: "tíqián", english: "In advance", category: "business" },
  { id: "bt-47", chinese: "紧急", pinyin: "jǐnjí", english: "Urgent", category: "business" },
  { id: "bt-48", chinese: "补货", pinyin: "bǔhuò", english: "Replenish stock", category: "business" },
  { id: "bt-49", chinese: "跟进", pinyin: "gēnjìn", english: "Follow up", category: "business" },
  { id: "bt-50", chinese: "合同", pinyin: "hétong", english: "Contract", category: "business" },
  { id: "bt-51", chinese: "确认", pinyin: "quèrèn", english: "To confirm", category: "business" },
  { id: "bt-52", chinese: "联系", pinyin: "liánxì", english: "To contact", category: "business" },
  { id: "bt-53", chinese: "期待", pinyin: "qīdài", english: "To look forward to", category: "business" },
];
...
export const businessSentences: BusinessSentence[] = [
  ...
  // Category 6: Lesson 3-8 Business Sentences
  {
    id: "bs-26",
    chinese: "我想咨询一下你们的业务",
    pinyin: "Wǒ xiǎng zīxún yīxià nǐmen de yèwù",
    english: "I'd like to inquire about your business",
    category: "Business Inquiry",
    context: "Opening a conversation about services offered",
  },
  {
    id: "bs-27",
    chinese: "这款产品符合我们的要求",
    pinyin: "Zhè kuǎn chǎnpǐn fúhé wǒmen de yāoqiú",
    english: "This product meets our requirements",
    category: "Business Inquiry",
    context: "Confirming a product matches specifications",
  },
  {
    id: "bs-28",
    chinese: "请确保颜色跟样品一样",
    pinyin: "Qǐng quèbǎo yánsè gēn yàngpǐn yīyàng",
    english: "Please ensure the color matches the sample",
    category: "Order Communication",
    context: "Specifying quality requirements before production",
  },
  {
    id: "bs-29",
    chinese: "我们需要紧急补货",
    pinyin: "Wǒmen xūyào jǐnjí bǔhuò",
    english: "We need an urgent restocking",
    category: "Order Communication",
    context: "Requesting emergency stock replenishment",
  },
  {
    id: "bs-30",
    chinese: "请提前通知我们交货时间",
    pinyin: "Qǐng tíqián tōngzhī wǒmen jiāohuò shíjiān",
    english: "Please notify us of delivery time in advance",
    category: "Order Communication",
    context: "Requesting advance notice on shipping schedule",
  },
  {
    id: "bs-31",
    chinese: "我会跟进这个订单",
    pinyin: "Wǒ huì gēnjìn zhège dìngdān",
    english: "I will follow up on this order",
    category: "Follow-up & Closing",
    context: "Committing to track an order's progress",
  },
  {
    id: "bs-32",
    chinese: "请确认合同的内容",
    pinyin: "Qǐng quèrèn hétong de nèiróng",
    english: "Please confirm the contract contents",
    category: "Follow-up & Closing",
    context: "Asking supplier to review and confirm contract details",
  },
  {
    id: "bs-33",
    chinese: "请尽快联系我",
    pinyin: "Qǐng jǐnkuài liánxì wǒ",
    english: "Please contact me as soon as possible",
    category: "Follow-up & Closing",
    context: "Requesting urgent follow-up communication",
  },
  {
    id: "bs-34",
    chinese: "期待与你们的长期合作",
    pinyin: "Qīdài yǔ nǐmen de chángqī hézuò",
    english: "Looking forward to long-term cooperation with you",
    category: "Follow-up & Closing",
    context: "Expressing interest in building an ongoing relationship",
  },
  {
    id: "bs-35",
    chinese: "我们需要沟通一下产品的细节",
    pinyin: "Wǒmen xūyào gōutōng yīxià chǎnpǐn de xìjié",
    english: "We need to discuss the product details",
    category: "Business Inquiry",
    context: "Initiating a detailed discussion about product specifications",
  },
];
